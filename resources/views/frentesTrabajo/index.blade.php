                    ...
                    <div class="overflow-hidden overflow-x-auto border border-gray-200 md:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200 text-sm">
                            ...
                            <tbody class="text-gray-700 text-base">
                                @foreach ($frentesTrabajo as $frenteTrabajo)
                                    <tr class="hover:bg-gray-100">
                                        <td class="px-2 py-1">{{ $frenteTrabajo->id }}</td>
                                        <td class="px-2 py-1">{{ $frenteTrabajo->descripcion }}</td>
                                        <td class="px-2 py-1">
                                            <div class="flex justify-end space-x-2">
                                                <div x-data="{ editOpen: false }" class="inline-block">
                                                    @can('editar frentes de trabajo')
                                                    ...
                                                    @endcan
                                                    @include('frentesTrabajo.modalEdit')
                                                </div>

                                                <div x-data="{ deleteOpen: false }" class="inline-block">
                                                    @can('eliminar frentes de trabajo')
                                                    ...
                                                    @endcan
                                                    @include('frentesTrabajo.modalDelete')
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
