                            ...
                            <tbody class="text-gray-700 text-base">
                                @foreach ($unidadMedidas as $unidadMedida)
                                    <tr class="hover:bg-gray-100">
                                        <td class="px-2 py-1">{{ $unidadMedida->id }}</td>
                                        <td class="px-2 py-1">{{ $unidadMedida->descripcion }}</td>
                                        <td class="px-2 py-1">
                                            <div class="flex justify-end space-x-2">
                                                <div x-data="{ editOpen: false }" class="inline-block">
                                                    @can('editar unidad de medidas')
                                                    ...
                                                    @endcan
                                                    @include('unidadMedidas.modalEdit')
                                                </div>

                                                <div x-data="{ deleteOpen: false }" class="inline-block">
                                                    @can('eliminar unidad de medidas')
                                                    ...
                                                    @endcan
                                                    @include('unidadMedidas.modalDelete')
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
